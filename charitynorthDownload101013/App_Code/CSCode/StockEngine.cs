...
public class StockEngine
{
  ...
  public string Symbol
  {
    ...
    set
    {
      if (String.IsNullOrEmpty(value) || value.Length < 1 || value.Length > 7)
        throw new ArgumentException("The stock symbol must be a valid 1-5 character string. Please enter only, one symbol at a time.");
