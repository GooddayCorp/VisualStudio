<%@ Control Language="C#" ClassName="access_rule_summary" %>
...
<script runat="server">
	...
	public string selectedRole, selectedUser;
    ...
    node.ImageUrl = (action.Substring(0, 5) == "ALLOW") ? "~/goodday/images/greenlight.gif" : "~/goodday/images/redlight.gif";
		...
		<tr>
			<td valign="top" style="padding-right: 30px;">
				...
				<asp:TreeView runat="server" ID="FolderTree"
					...
					<LeafNodeStyle ImageUrl="~/goodday/images/folder.gif" 
            VerticalPadding="2px" />
