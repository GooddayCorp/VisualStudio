<%@ Control Language="C#" ClassName="access_rules" %>
...
<script runat="server">
	...
	private void PopulateTree()
	{
		...
		try
		{
      FolderTree.SelectedNode.ImageUrl = "~/goodday/images/target.gif";
		}
		catch { }
	}
    ...
    FolderTree.SelectedNode.ImageUrl = "~/goodday/images/target.gif"; // Set the newly selected folder's ImageUrl.
	}
    ...
    parentNode.ImageUrl = "~/goodday/images/folder.gif";
...
<tr>
	<td class="details" valign="top">
		...
		<tr>
            ...
            Width="139px">
					<RootNodeStyle ImageUrl="~/goodday/images/folder.gif" />
					<ParentNodeStyle ImageUrl="~/goodday/images/folder.gif" />
					<NodeStyle HorizontalPadding="10px" VerticalPadding="5px" />
					<LeafNodeStyle ImageUrl="~/goodday/images/folder.gif" HorizontalPadding="10px" 
            Width="15px" />
