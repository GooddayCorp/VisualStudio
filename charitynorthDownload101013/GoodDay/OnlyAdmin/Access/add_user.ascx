<%@ Control Language="C#" ClassName="add_user" %>
...
<script runat="server">
    ...
    //newUser.PasswordQuestion = pwdquestion.Text;
    //newUser.PasswordAnswer = pwdanswer.Text;
...
<tr>
	<td class="detailheader">Pwd Question </td>
	<td>
		<asp:TextBox ID="pwdquestion" runat="server"></asp:TextBox>
	</td>
</tr>
<tr>
	<td class="detailheader">Pwd Answer</td>
	<td>
		<asp:TextBox ID="pwdanswer" runat="server"></asp:TextBox>
	</td>
</tr>
<tr>
