<%@ Page Title="" Language="C#" MasterPageFile="~/Goodday/MasterAdmin.master" AutoEventWireup="true" CodeFile="online_users.aspx.cs" Inherits="MenuTabs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodycontent" Runat="Server">
  <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" 
    ...
    <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="Users">
      <ContentTemplate>
        <mike:online_users runat="server" />
      </ContentTemplate>
    </asp:TabPanel>    
