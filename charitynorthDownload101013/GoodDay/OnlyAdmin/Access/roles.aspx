<%@ Page Title="" Language="C#" MasterPageFile="~/Goodday/MasterAdmin.master" AutoEventWireup="true" CodeFile="roles.aspx.cs" Inherits="MenuTabs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodycontent" Runat="Server">
  <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="4" Width="100%">
    <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="Users">
      <ContentTemplate>
        <mike:users runat="server" />
      </ContentTemplate>
    </asp:TabPanel>    
