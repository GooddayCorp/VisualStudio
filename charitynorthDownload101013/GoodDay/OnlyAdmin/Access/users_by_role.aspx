<%@ Page Title="" Language="C#" MasterPageFile="~/Goodday/MasterAdmin.master" AutoEventWireup="true" CodeFile="users_by_role.aspx.cs" Inherits="MenuTabs" %>
  ...
  <asp:Content ID="Content2" ContentPlaceHolderID="bodycontent" Runat="Server">
    <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
      <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="Users">
        <ContentTemplate>
          <mike:users_by_role runat="server" />         
        </ContentTemplate>  
      </asp:TabPanel>    
      ...
      <asp:TabPanel ID="TabPanel3" runat="server" HeaderText="Rule Summary" >
         <ContentTemplate>
             <mike:access_rule_summary runat="server" />                </ContentTemplate>   
      </asp:TabPanel>
