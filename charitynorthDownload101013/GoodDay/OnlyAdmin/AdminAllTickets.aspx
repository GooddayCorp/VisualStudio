<%@ Page Title="" Language="C#" MasterPageFile="~/Goodday/MasterAdmin.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="True" CodeFile="AdminAllTickets.aspx.cs" Inherits="AdminwithListBoxes" %>
      ...
      <td class="newTicket" valign="top">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
          ...
          <Columns>
            ...
            <asp:BoundField DataField="DateIssue" HeaderText="Issued"  HtmlEncode="False" DataFormatString = "{0:g}"  
