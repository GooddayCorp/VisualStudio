...
Partial Class ViewCart
    ...
    Protected Sub ibPayPal_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibPayPal.Click
        ...
        If cost = 0 Then
          Response.Redirect("~/PayPal/Default.aspx?cartIsEmpty=true")
        End If
...
Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        If gvCarts.Rows.Count = 0 Then
          Label1.Text = "Your shopping cart is empty."
          Response.Redirect("~/PayPal/Default.aspx?cart_id=" + Request.QueryString("cart_id") + "&cartIsEmpty=true")
        Else
          Label1.Text = ""
          Response.Redirect("~/PayPal/Default.aspx?cart_id=" + Request.QueryString("cart_id") + "&cartIsEmpty=false")
        End If
